...
def main():
    ...
    ###################################     # create Simulation
    simulation = Simulation(timesteps=timesteps, params=params, initial_water_map=twelve_cm_deep, initial_external_shade_map=shademap_03, init_species='capillifolium')
    #########################################################################################################
    ...
    # DUMMY RUN
    runs_height, runs_masses, shades, waters = simulation.run(adapt_water_table_height_to_average_carpet_height=True, adapted_depth_below_average_carpet_height=12.0)
    ...
    # plot bands
    _,_, species = stats.plot_means_and_bands_of_runs(fig=fig, ax=ax1, simulation=simulation, scaling=True, number_of_runs=number_of_runs, adapt_water_table_height_to_average_carpet_height=True, adapted_depth_below_average_carpet_height=12.0)
