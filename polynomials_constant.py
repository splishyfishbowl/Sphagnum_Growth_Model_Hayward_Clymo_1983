...
def main():
    ...
    growth_model.set_treat_values_outside_polynomial_growth_as_constants(True)
    growth_model.set_approximate_height_by_mass(False)
    ...
    # WTD   0.0 - 14.0
    # Shade 0.0 -  1.3
    WTD = np.arange(0, 20, 0.1)
    S = np.arange(0, 1.5, 0.1)
    ...
    plt.savefig("/home/louis-dee/GitHub/Moss_growth/.venv_Model_Sphag/HaywardAndClymo1983/Thesis_Tex_files/Plots/Replication/polynomials_constant_edge.pdf")
