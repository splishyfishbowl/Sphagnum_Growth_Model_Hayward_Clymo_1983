...
def main():
    ...
    # Save TIME SERIES
    fig_path_and_name = Path(f'~/GitHub/Moss_growth/.venv_Model_Sphag/HaywardAndClymo1983/Thesis_Tex_files/Plots/Watertable_dynamical/WT_dyn_{species}_bands_water.pdf').expanduser()
    fig.savefig(str(fig_path_and_name))

    # Save HEATMAP HEIGHT
    fig_path_and_name = Path(f'~/GitHub/Moss_growth/.venv_Model_Sphag/HaywardAndClymo1983/Thesis_Tex_files/Plots/Watertable_dynamical/WT_dyn_{species}_heatmap_height.pdf').expanduser()
    fig2.savefig(str(fig_path_and_name))

    # Save HEATMAP MASS
    fig_path_and_name = Path(f'~/GitHub/Moss_growth/.venv_Model_Sphag/HaywardAndClymo1983/Thesis_Tex_files/Plots/Watertable_dynamical/WT_dyn_{species}_heatmap_mass.pdf').expanduser()
